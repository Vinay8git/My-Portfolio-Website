...
const profile = {
    name: 'Vinay Yadav',
    title: 'Software Developer | Blockchain Enthusiast | Problem Solver',
    skills: [
        'Java', 'JavaScript', 'Python', 'C++', 'HTML', 'CSS', 'C'
        'React', 'NodeJS', 'Express', 'MongoDB', 'PostgreSQL',
        'RESTful APIs', 'Git', 'Github', 'GCP'
        'Data Structures', 'Algorithms', 'Competitive Programming',
        'Problem Solving', 'System Design', 'OOP', 'DBMS', 'OS'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
          ...
          <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 py-12 lg:py-0">
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                ...
                "⚙️ Forging next-gen tech with Java, JavaScript & Blockchain 🚀 
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/Vinay8git"
