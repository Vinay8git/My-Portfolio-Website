...
const SkillsSection = () => {
  ...
  const achievements = [
      ...
      skills: [
        {
          ...
          link: "https://drive.google.com/file/d/1pdocjcCrPhF6QEU2r8Nwracz0a3j7zsu/view?usp=sharing",
        },
    ...
    {
      icon: Award,
      title: "All India Rank 9703 In Gate 2025",
      color: "text-blue-400",
      skills: [
        {
          name: "Computer Science & Information Technology",
          icon: <Award className="w-4 h-4 text-orange-400" />,
          link: "https://drive.google.com/file/d/1NF0OkKVK3i6MujCRRAncVBzEzWIXNQsy/view?usp=sharing",
        },
      ],
    },
    {
      ...
      skills: [
        {
          name: "CodeNCompete IIT Kanpur Techkriti 2025",
          icon: <Award className="w-4 h-4 text-orange-400" />,
          link: "",
        },
      ],
    ...
    {
      icon: Award,
      title: "Global Rank 685",
      color: "text-blue-400",
      skills: [
        {
          name: "LeetCode Weekly Contest 414 & Max Rating Of 1607",
          icon: <Award className="w-4 h-4 text-orange-400" />,
          link: "https://drive.google.com/file/d/1PdcxDnLM7PkI54ncKQ-leOvehno1g8j2/view?usp=sharing",
        },
      ],
    },
    {
      icon: FaJava,
      title: (<>5 <FaStar className="inline text-orange-400" /> Problem Solver & Java Programmer</>),
      color: "text-blue-400",
      skills: [
        {
          name: "Hackerrank",
          icon: <Award className="w-4 h-4 text-orange-400" />,
          link: "https://www.hackerrank.com/profile/DS2A_1641540126",
        },
      ],
    },
    {
      icon: Award,
      title: "Harvard's Aspire Leaders Programme",
      color: "text-blue-400",
      skills: [
        {
          name: "Selected among vast number of international applicants for ALP 2025 Cohort 1 and successfully completed the program, earning status of Aspire Alumni.",
          icon: <Award className="w-4 h-4 text-orange-400" />,
          link: "https://drive.google.com/drive/folders/11l8f7aSwRb2HIQAfJIH53v5DBSS4w6yY?usp=sharing",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      skills: [
        {
          name: "@Hacktoberfest 2024 by Digital Ocean",
          icon: <Award className="w-4 h-4 text-orange-400" />,
          link: "https://www.holopin.io/@vinay8git#badges",
        },
      ],
    },
  ];
