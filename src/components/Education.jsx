  ...
  const educationData = [
    {
      ...
      mascot: "📘",
      year: "2022-2026",
      achievements: ["CGPA: 8.8", "Subject: Computer Science"],
      skills: ["Java", "Python", "Javascript", "Data Structures", "Algorithms", "DBMS", "Web Development", "OS", "CN", "OOPS", "System Design"],
      description:
    ...
    },
    {
      ...
      school: "Dr Virendra Swaroop Public School",
      mascot: "📗",
      year: "2021-2022",
      achievements: ["Percentage: 92.25%", "Subject: Science & CS"],
